...
namespace Middle.PostgreSql
{
    public class MiddlePostgres
    {
        ...
        public T ExecuteSingle<T>(string querySql, params object[] args) where T : new()
        {
            return this.Execute<T>(querySql, args).FirstOrDefault();
        }
        ...
        public NpgsqlDataReader OpenReader(string querySql, params object[] args)
        {
        ...
        public IEnumerable<T> Execute<T>(string querySql, params object[] args) where T : new()
        {
        ...
        public IEnumerable<dynamic> ExecuteDynamic(string querySql, params object[] args)
        {
            using (var reader = OpenReader(querySql, args))
            {
                while (reader.Read())
